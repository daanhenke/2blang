...
<template>
  <div class="layout">
    <AppHeader title="2b" :home-path="`${sitePrefix}/`">
      <template #nav>
      ...
      <template #actions>
        <a
          href="https://github.com/your-org/2blang"
          target="_blank"
          rel="noopener"
    ...
    <AppFooter>
      <a href="https://github.com/your-org/2blang" target="_blank" rel="noopener">GitHub</a>
    </AppFooter>
  </div>
</template>
